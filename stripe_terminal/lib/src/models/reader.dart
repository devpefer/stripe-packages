...
class Reader with _$Reader {
  ...
  /// Crea un objeto Reader a partir de un mapa JSON
  factory Reader.fromJson(Map<String, dynamic> json) {
    return Reader(
      locationStatus: json['locationStatus'] != null ? LocationStatus.values[json['locationStatus']] : null,
      deviceType: json['deviceType'] != null ? DeviceType.values[json['deviceType']] : null,
